App({
  data: {
    ...
    // 下箭头icon
    default_icon_arrow_bottom: "/images/default-icon-arrow-bottom.png",

    // 全选icon
    default_icon_choose: "/images/default-icon-choose.png",

    // 全选中列表icon
    default_icon_choose_checked: "/images/default-icon-choose-checked.png",

    // 帮助icon
    default_icon_help: "/images/default-icon-help.png",

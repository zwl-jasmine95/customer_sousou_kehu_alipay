...
Page({
  ...
  get_data_list(is_mandatory) {
    ...
    // 获取数据
    my.httpRequest({
      url: app.get_request_url("Index", "SendOrder"),
      method: "POST",
      data: {
        page: this.data.data_page,
        keywords: this.data.input_value || ""
      },
      dataType: "json",
      success: res => {
        my.hideLoading();
  ...
  pay_event(e) {
    ...
    my.httpRequest({
      url: app.get_request_url("Pay", "SendOrder"),
      method: "POST",
      data: {
        id: id
      },
    ...
    my.confirm({
      ...
      success: result => {
        if (result.confirm) {
          ...
          my.httpRequest({
            url: app.get_request_url("Cancel", "SendOrder"),
            method: "POST",
            data: {
              id: id
            },
